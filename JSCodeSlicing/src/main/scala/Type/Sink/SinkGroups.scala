...
object SinkGroups {
  ...
  private val FILE_OPERATIONS: Seq[TypeDefinition] = Seq(
    // Write Operations
    RegexType("writeFile"),      // writeFile, promiswriteFile
    RegexType("writeFileSync"),
    RegexType("appendFile"),     // appendFile
    RegexType("appendFileSync"),
    RegexType("createWriteStream"),
    RegexType("write"),          // write, procestdowrite
    RegexType("writeSync"),
    RegexType("writev"),
    RegexType("writevSync"),
    // RegexType("save"),           // mongoosave (thường là ghi DB nhưng cũng tính là IO sink)
  ...
  private val SYSTEM_COMMAND_EXECUTION: Seq[TypeDefinition] = Seq(
    ...
    RegexType("exec"),           // child_exec, exec
    RegexType("execSync"),
    RegexType("spawn"),          // child_spawn
    RegexType("spawnSync"),
    RegexType("fork"),           // child_fork
    RegexType("execFile"),
